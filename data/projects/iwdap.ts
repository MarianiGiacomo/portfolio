...
const data: Project = {
  ...
  links: {
    ...
    'Developer tools exercise': new URL(
      'https://acos.cs.hut.fi/html/webdev/webdev-inspector/modify_list',
    ),
    'Find the right element exercise': new URL(
      'https://acos.cs.hut.fi/html/webdev/webdev-editor/find_the_right_element',
    ),
    'Remove element exercise': new URL(
      'https://acos.cs.hut.fi/html/webdev/webdev-editor/remove_element',
    ),
    'Modify element exercise': new URL(
      'https://acos.cs.hut.fi/html/webdev/webdev-editor/modify_element_innerText',
    ),
