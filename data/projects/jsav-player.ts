...
const data: Project = {
  ...
  links: {
    ...
    'GitHub test application': new URL(
      'https://github.com/MarianiGiacomo/jsav-player-application-test-app',
    ),
    'GitHub Exercise Recorder': new URL(
      `https://github.com/MarianiGiacomo/jsav-exercise-recorder`,
    ),
    'GitHub Exercise Player': new URL(
      `https://github.com/MarianiGiacomo/jsav-exercise-player`,
    ),
    'GitHub test server': new URL(
      `https://github.com/MarianiGiacomo/jsav-player-application-test-server`,
    ),
    Publication: new URL(
